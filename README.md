...
**This version is obsolete, kept only for those not able to use gtk4, please use the [flatpak](https://github.com/AchetaGames/Epic-Asset-Manager/releases/tag/v1.0.10) if at all posible**
