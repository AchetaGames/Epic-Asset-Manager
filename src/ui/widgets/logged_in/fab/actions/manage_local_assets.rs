...
pub mod imp {
    ...
    #[template(
        resource = "/io/github/achetagames/epic_asset_manager/fab/actions/manage_local_assets.ui"
    )]
    pub struct FabLocalAssets {
    ...
    impl ObjectSubclass for FabLocalAssets {
        const NAME: &'static str = "FabLocalAssets";
        type Type = super::FabLocalAssets;
    ...
    impl ObjectImpl for FabLocalAssets {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabLocalAssets {}
    impl BoxImpl for FabLocalAssets {}
}

glib::wrapper! {
    pub struct FabLocalAssets(ObjectSubclass<imp::FabLocalAssets>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabLocalAssets {
    fn default() -> Self {
        Self::new()
    }
}
...
impl FabLocalAssets {
                ...
                for rel in releases {
                    if let Some(app) = &rel.app_id {
                        for location in crate::models::asset_data::AssetData::downloaded_locations(
                            ...
                            let row = super::local_asset::FabLocalAsset::new();
                            row.set_property(
                                "label",
                                location
                                    .into_os_string()
    ...
    pub fn delete(&self, widget: &super::local_asset::FabLocalAsset) {
        let self_ = self.imp();
