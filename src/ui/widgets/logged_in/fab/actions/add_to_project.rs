...
pub mod imp {
    ...
    #[template(
        resource = "/io/github/achetagames/epic_asset_manager/fab/actions/add_to_project.ui"
    )]
    pub struct FabAddToProject {
    ...
    impl ObjectSubclass for FabAddToProject {
        const NAME: &'static str = "FabAddToProject";
        type Type = super::FabAddToProject;
    ...
    impl ObjectImpl for FabAddToProject {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabAddToProject {}
    impl BoxImpl for FabAddToProject {}
}

glib::wrapper! {
    pub struct FabAddToProject(ObjectSubclass<imp::FabAddToProject>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabAddToProject {
    fn default() -> Self {
        Self::new()
    }
}

impl FabAddToProject {
    pub fn new() -> Self {
        glib::Object::new()
    }
