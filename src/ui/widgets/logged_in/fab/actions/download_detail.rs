...
pub mod imp {
    ...
    #[template(
        resource = "/io/github/achetagames/epic_asset_manager/fab/actions/download_detail.ui"
    )]
    pub struct FabDownloadDetails {
    ...
    impl ObjectSubclass for FabDownloadDetails {
        const NAME: &'static str = "FabDownloadDetails";
        type Type = super::FabDownloadDetails;
    ...
    impl ObjectImpl for FabDownloadDetails {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabDownloadDetails {}
    impl BoxImpl for FabDownloadDetails {}
}

glib::wrapper! {
    pub struct FabDownloadDetails(ObjectSubclass<imp::FabDownloadDetails>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabDownloadDetails {
    fn default() -> Self {
        Self::new()
    }
}

impl FabDownloadDetails {
    pub fn new() -> Self {
        glib::Object::new()
    }
