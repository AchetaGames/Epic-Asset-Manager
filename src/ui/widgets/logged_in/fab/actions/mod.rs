...
pub mod imp {
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/asset_actions.ui")]
    pub struct FabAssetActions {
        ...
        #[template_child]
        pub download_details: TemplateChild<download_detail::FabDownloadDetails>,
        #[template_child]
        pub additional_details: TemplateChild<gtk4::ListBox>,
        #[template_child]
        pub add_to_project: TemplateChild<add_to_project::FabAddToProject>,
        #[template_child]
        pub create_asset_project: TemplateChild<create_asset_project::FabCreateAssetProject>,
        #[template_child]
        pub local_assets: TemplateChild<manage_local_assets::FabLocalAssets>,
        pub details_group: gtk4::SizeGroup,
    }

    #[glib::object_subclass]
    impl ObjectSubclass for FabAssetActions {
        const NAME: &'static str = "FabAssetActions";
        type Type = super::FabAssetActions;
    ...
    impl ObjectImpl for FabAssetActions {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabAssetActions {}
    impl BoxImpl for FabAssetActions {}
}

glib::wrapper! {
    pub struct FabAssetActions(ObjectSubclass<imp::FabAssetActions>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabAssetActions {
    fn default() -> Self {
        Self::new()
    }
}

impl FabAssetActions {
    pub fn new() -> Self {
        glib::Object::new()
    }
