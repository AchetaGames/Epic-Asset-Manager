...
pub mod imp {
    ...
    #[template(
        resource = "/io/github/achetagames/epic_asset_manager/fab/actions/create_asset_project.ui"
    )]
    pub struct FabCreateAssetProject {
    ...
    impl ObjectSubclass for FabCreateAssetProject {
        const NAME: &'static str = "FabCreateAssetProject";
        type Type = super::FabCreateAssetProject;
    ...
    impl ObjectImpl for FabCreateAssetProject {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabCreateAssetProject {}
    impl BoxImpl for FabCreateAssetProject {}
}

glib::wrapper! {
    pub struct FabCreateAssetProject(ObjectSubclass<imp::FabCreateAssetProject>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabCreateAssetProject {
    fn default() -> Self {
        Self::new()
    }
}

impl FabCreateAssetProject {
    pub fn new() -> Self {
        glib::Object::new()
    }
