...
pub mod imp {
    ...
    use crate::ui::widgets::logged_in::fab::actions;
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/asset_detail.ui")]
    pub struct FabAssetDetails {
        ...
        #[template_child]
        pub asset_actions: TemplateChild<actions::FabAssetActions>,
    ...
    impl ObjectSubclass for FabAssetDetails {
        const NAME: &'static str = "FabAssetDetails";
        type Type = super::FabAssetDetails;
    ...
    impl ObjectImpl for FabAssetDetails {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabAssetDetails {}
    impl BoxImpl for FabAssetDetails {}
}

glib::wrapper! {
    pub struct FabAssetDetails(ObjectSubclass<imp::FabAssetDetails>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabAssetDetails {
    fn default() -> Self {
        Self::new()
    }
}

impl FabAssetDetails {
    pub fn new() -> Self {
        glib::Object::new()
    }
    ...
    pub fn setup_actions(&self) {
            ...
            clone!(
                ...
                move |_, _| {
                    details.show_download_details(
                        &crate::ui::widgets::logged_in::fab::actions::Action::Download,
                    );
                }
            )
        );
        ...
        action!(
            ...
            clone!(
                ...
                move |_, _| {
                    details.show_download_details(
                        &crate::ui::widgets::logged_in::fab::actions::Action::CreateProject,
                    );
                }
            )
        );
        ...
        action!(
            ...
            clone!(
                ...
                move |_, _| {
                    details.show_download_details(
                        &crate::ui::widgets::logged_in::fab::actions::Action::Local,
                    );
                }
            )
        );
        ...
        action!(
            ...
            clone!(
                ...
                move |_, _| {
                    details.show_download_details(
                        &crate::ui::widgets::logged_in::fab::actions::Action::AddToProject,
                    );
                }
            )
        );
    ...
    fn show_download_details(&self, action: &crate::ui::widgets::logged_in::fab::actions::Action) {
        let self_ = self.imp();
