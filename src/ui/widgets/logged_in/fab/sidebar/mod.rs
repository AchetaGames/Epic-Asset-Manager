use crate::ui::widgets::logged_in::fab::sidebar::categories::FabSidebarCategories;
use gtk4::glib::clone;
...
pub mod imp {
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/sidebar.ui")]
    pub struct FabSidebar {
        pub actions: gio::SimpleActionGroup,
        pub download_manager: OnceCell<EpicDownloadManager>,
        pub window: OnceCell<EpicAssetManagerWindow>,
        pub settings: gtk4::gio::Settings,
        pub loggedin: OnceCell<crate::ui::widgets::logged_in::fab::FabLibraryBox>,
        ...
        #[template_child]
        pub all_category: TemplateChild<button::FabSidebarButton>,
        #[template_child]
        pub unreal_category: TemplateChild<button::FabSidebarButton>,
        #[template_child]
        pub games_category: TemplateChild<button::FabSidebarButton>,
        #[template_child]
    ...
    impl ObjectSubclass for FabSidebar {
        const NAME: &'static str = "FabSidebar";
        type Type = super::FabSidebar;
    ...
    impl ObjectImpl for FabSidebar {
        fn constructed(&self) {
    ...
    impl WidgetImpl for FabSidebar {}
    impl BoxImpl for FabSidebar {}
}

glib::wrapper! {
    pub struct FabSidebar(ObjectSubclass<imp::FabSidebar>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabSidebar {
    fn default() -> Self {
        Self::new()
    }
}
...
impl FabSidebar {
    ...
    pub fn set_logged_in(&self, loggedin: &crate::ui::widgets::logged_in::fab::FabLibraryBox) {
        let self_ = self.imp();
        // Do not run this twice
    ...
    pub fn setup_widgets(&self) {
        ...
        // Unreal Category
        let c = categories::FabSidebarCategories::new(
            "Unreal Engine",
            "unreal",
        ...
        // Games Category
        let c =
            categories::FabSidebarCategories::new("Games", "games", Some("games|dlc"), Some(self));
        c.set_widget_name("games");
        self_.stack.add_named(&c, Some("games"));
        // All Category
        let c = categories::FabSidebarCategories::new("All", "all", None, Some(self));
    ...
    fn category_by_name(&self, name: &str) -> Option<FabSidebarCategories> {
        let self_ = self.imp();
        if let Some(w) = self_.stack.child_by_name(name) {
            return w
                .downcast_ref::<categories::FabSidebarCategories>()
                .cloned();
        }
        None
    }
    ...
    fn add_category_by_name(&self, part: &str, p: &str) -> FabSidebarCategories {
        let self_ = self.imp();
        self.category_by_name(p).map_or_else(
            || {
                let c = categories::FabSidebarCategories::new(
                    &categories::FabSidebarCategories::capitalize_first_letter(part),
                    p,
                    Some(part),
                    Some(self),
                );
