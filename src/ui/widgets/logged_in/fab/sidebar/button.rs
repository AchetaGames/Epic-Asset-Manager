...
pub mod imp {
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/sidebar_button.ui")]
    pub struct FabSidebarButton {
    ...
    impl ObjectSubclass for FabSidebarButton {
        const NAME: &'static str = "FabSidebarButton";
        type Type = super::FabSidebarButton;
    ...
    impl ObjectImpl for FabSidebarButton {
    ...
    impl WidgetImpl for FabSidebarButton {}
    impl BoxImpl for FabSidebarButton {}
}

glib::wrapper! {
    pub struct FabSidebarButton(ObjectSubclass<imp::FabSidebarButton>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabSidebarButton {
    fn default() -> Self {
        Self::new()
    }
}

impl FabSidebarButton {
    pub fn new() -> Self {
        glib::Object::new()
    }

    pub fn set_sidebar(&self, loggedin: &crate::ui::widgets::logged_in::fab::sidebar::FabSidebar) {
        let self_ = self.imp();
