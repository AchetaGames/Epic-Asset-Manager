...
pub mod imp {
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/sidebar_categories.ui")]
    pub struct FabSidebarCategories {
        pub title: RefCell<Option<String>>,
        pub icon_name: RefCell<Option<String>>,
        pub path: RefCell<Option<String>>,
        pub filter: RefCell<Option<String>>,
        pub sidebar: OnceCell<crate::ui::widgets::logged_in::fab::sidebar::FabSidebar>,
    ...
    impl ObjectSubclass for FabSidebarCategories {
        const NAME: &'static str = "FabSidebarCategories";
        type Type = super::FabSidebarCategories;
    ...
    impl ObjectImpl for FabSidebarCategories {
    ...
    impl WidgetImpl for FabSidebarCategories {}
    impl BoxImpl for FabSidebarCategories {}
}

glib::wrapper! {
    pub struct FabSidebarCategories(ObjectSubclass<imp::FabSidebarCategories>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabSidebarCategories {
    fn default() -> Self {
        Self::new("", "", None, None)
    }
}

impl FabSidebarCategories {
    pub fn new(
        title: &str,
        path: &str,
        filter: Option<&str>,
        sidebar: Option<&crate::ui::widgets::logged_in::fab::sidebar::FabSidebar>,
    ) -> Self {
    ...
    pub fn set_sidebar(&self, sidebar: &crate::ui::widgets::logged_in::fab::sidebar::FabSidebar) {
        let self_ = self.imp();
    ...
    pub fn setup_categories(&self) {
        ...
        factory.connect_setup(move |_factory, item| {
            ...
            item.set_child(Some(
                &crate::ui::widgets::logged_in::fab::sidebar::category::FabSidebarCategory::new(),
            ));
        });
        ...
        factory.connect_bind(move |_factory, list_item| {
            ...
            let child = list_item.child().unwrap().downcast::<crate::ui::widgets::logged_in::fab::sidebar::category::FabSidebarCategory>().unwrap();
