...
pub mod imp {
    ...
    #[template(resource = "/io/github/achetagames/epic_asset_manager/fab/asset.ui")]
    pub struct FabAsset {
    ...
    impl ObjectSubclass for FabAsset {
        const NAME: &'static str = "FabAsset";
        type Type = super::FabAsset;
    ...
    impl WidgetImpl for FabAsset {}
    impl BoxImpl for FabAsset {}
}

glib::wrapper! {
    pub struct FabAsset(ObjectSubclass<imp::FabAsset>)
        @extends gtk4::Widget, gtk4::Box;
}

impl Default for FabAsset {
    fn default() -> Self {
        Self::new()
    }
}
